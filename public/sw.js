const CACHE='owner-property-shell-v3.8.0';
const SHELL=['/','/app.css?v=3.8.0','/simple.css?v=3.8.0','/app.js?v=3.8.0','/form-safety.js?v=3.8.0','/manifest.webmanifest','/icon.svg'];
